...
const BookingMenu = () => {
  ...
  return (
    <div className="flex items-center justify-between bg-white rounded-lg mx-auto -mt-20 z-[99] shadow-gray-700 shadow-lg">
      {/* Place Dropdown */}
      <div className="w-[30%]"><PlaceDropdown place={place} setPlace={setPlace} /></div>
      

      {/* Check-In Date Picker */}
      <div className="w-[20%]"><CheckInPicker
        label="Check-in Date"
      ...
      <div className="w-[20%]"><CheckOutPicker
      ...
      {/* Rooms & Guests */}
      <div className="w-[30%]"><RoomsAndGuestsDropdown data={roomsAndGuests} setData={setRoomsAndGuests} /></div>

...
const Footer = () => {
  ...
  return (
    <div className=" pt-10 px-16 bg-secondary text-white w-full xsm:px-4 xsm:p-4 sm:px-4 font-jost">
      <div className="w-full flex justify-between xsm:flex-col sm:flex-col md:flex-col">
        <div className="w-[35%] xsm:w-full sm:w-full md:w-full">
          <div className=" flex-col">
            ...
            Experience luxury and comfort, where every detail is designed to make your stay memorable. From exquisite dining to personalized service, we are here to make your visit exceptional. Building the best network where you can get all types of information to ensure a seamless stay.</p>         </div>
        ...
        <div className="w-[60%] flex justify-items-end mt-6 xsm:w-full sm:w-full xsm:mt-4 md:w-full md:mt-12">
          ...
          <h1 className="font-[700] xsm:text-sm sm:text-sm xsm:text-center sm:text-center text-2xl">Contact Us</h1>
          <div className='content'>
            <div>
              <div><FaLocationDot size={20}/></div>
              <p className="xsm:text-xxs sm:text-xxs">123 Luxury Lane, Dream City, Country
</p>
            </div>
            <div className="mb-4 xsm:justify-center">
              <div className="flex">
                <div><IoMdMail size={20} /></div>
                <p className='xsm:text-xxs sm:text-xxs'>info@almaris.in</p>
              </div>
              <div>
              <IoMdCall className="bg-white text-secondary rounded-full p-1 ml-8" size={20}/>
                <p className='xsm:text-xxs sm:text-xxs'>7896541230</p>
              </div>
            </div>
            <h1 className="font-[600] pb-2 xsm:text-sm sm:text-sm xsm:text-center sm:text-center md:text-center text-xl">Follow us on social media</h1>
          <div className="flex xsm:justify-center sm:justify-center md:justify-center w-full">
          <a href="https://www.facebook.com/share/1E5UTzoWjW/?mibextid=LQQJ4d" target="_blank" rel="noopener noreferrer" >
      ...
      >
        <div><CgInstagram size={25} className="mx-8" /></div>
      </a>          
      <a 
      ...
      <div className="py-8 text-xs text-center lg:text-sm xl:text-sm 2xl:text-base">©  ALMARIS 2024 ALL RIGHTS RESERVED.</div>
    </div>
  );
};
